...
const Header = () => {
  return (
    <div className='w-full flex flex-col lg:flex-row px-4 md:px-10 gap-10 2xl:gap-20 py-20'>
      ...
      >
        <span className='text-lg font-bold text-violet-700 dark:text-red-600 tracking-wider'>
        ...
        <div className='flex gap-4 items-center my-4'>
          ...
          <div className='flex items-center justify-center dark:bg-[#224cff10] dark:text-red-700 text-white shadow-lg bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-[#55079e] to-[#7f0c29]  rounded-full'>
        ...
        <h1 className='text-5xl 2xl:text-7xl font-extrabold text-violet-700 dark:text-red-600 tracking-wider'>
          CodeAZAL
        </h1>

        <p className='text-md text-neutral dark:text-white mt-5 2xl:mt-10'>
        ...
        <div className='mt-10 flex gap-10'>
          ...
          <a href='#projects'>
            <button className=' hover:scale-110  text-lg text-white fonnt-semibold rounded-md py-3 px-5 bg-black dark:bg-[#224cff10]'>
              Projects
            </button>
          </a>
        </div>
